	...
	"<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>				\
	 <LangFile>									\
	   ...
	   <data>									\
	     ...
	     <entry string=\"Space\">Leertaste</entry>					\
	     <entry string=\"PgUp\">Bild auf</entry>					\
	     <entry string=\"PgDown\">Bild ab</entry>					\
	     <entry string=\"End\">Ende</entry>						\
	     <entry string=\"Home\">Pos1</entry>					\
	     <entry string=\"Left\">Pfeil links</entry>					\
	     <entry string=\"Up\">Pfeil hoch</entry>					\
	     <entry string=\"Right\">Pfeil rechts</entry>				\
	     <entry string=\"Down\">Pfeil runter</entry>				\
	     <entry string=\"Ins\">Einfg</entry>					\
	     <entry string=\"Del\">Entf</entry>						\

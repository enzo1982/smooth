	 ...
	 <LangFile>									\
	   ...
	   <data>									\
	     ...
	     <entry string=\"Ignore\">Ignorer</entry>					\
											\
	     <entry string=\"Undo\">Annuler</entry>					\
	     <entry string=\"Cut\">Couper</entry>					\
	     ...
	     <entry string=\"Down\">Bas</entry>						\
	     <entry string=\"Ins\">Inser.</entry>					\
	     <entry string=\"Del\">Suppr.</entry>					\
	     <entry string=\"Ctrl\">Ctrl</entry>					\
	     <entry string=\"Alt\">Alt</entry>						\
	     <entry string=\"Shift\">Maj</entry>					\
											\
	     <entry string=\"Open file\">Ouvrir un fichier</entry>			\
	     <entry string=\"Save file\">Enregistrer le fichier</entry>			\
	     <entry string=\"Save file as\">Enregistrer le fichier sous</entry>		\
	     <entry string=\"Select directory\">Choisir un dossier</entry>		\
	     <entry string=\"Select font\">Choisir une police</entry>			\
											\
	     <entry string=\"Color selection\">Choisir une couleur</entry>		\
	     <entry string=\"HTML code\">Code HTML</entry>				\

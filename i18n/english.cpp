...
#ifndef __OBJSMOOTH_ENGLISH_
#define __OBJSMOOTH_ENGLISH_
...
{
	if (SMOOTHString(lpelfe->elfLogFont.lfFaceName) == "Microsoft Sans Serif")	return 0;
	else										return 1;
}
...
void ActivateEnglishLanguage()
{
	...
	TXT_SMOOTHTOOLWINDOW = "SMOOTHToolWindow";

...
#include <smooth/gui/window/gdi/windowgdi.h>
...
S::Int S::GUI::WindowGDI::Open(String title, Point pos, Size size, Int flags)
{
...
S::Int S::GUI::WindowGDI::SetTitle(String nTitle)
{
...
S::Int S::GUI::WindowGDI::SetMinimumSize(Size nMinSize)
{
	minSize = nMinSize;
...
S::Int S::GUI::WindowGDI::SetMaximumSize(Size nMaxSize)
{
	maxSize = nMaxSize;

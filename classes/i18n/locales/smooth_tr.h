...
static const char *smooth_tr = 
	...
	"<?xml version=\"1.0\" encoding=\"UTF-8\"?>						\
	 <LangFile>										\
	   ...
	   <data>										\
	     <entry string=\"OK\">Tamam</entry>							\
	     <entry string=\"Cancel\">İptal</entry>						\
	     <entry string=\"Yes\">Evet</entry>							\
	     <entry string=\"No\">Hayır</entry>							\
	     ...
	     <entry string=\"Next tip\">İleri</entry>						\
	   </data>										\
	 </LangFile>";

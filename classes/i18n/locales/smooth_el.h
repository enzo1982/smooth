...
#ifndef H_OBJSMOOTH_I18N_EL
#define H_OBJSMOOTH_I18N_EL

static const char *smooth_el = 

	"<?xml version=\"1.0\" encoding=\"UTF-8\"?>					\
	 <LangFile>									\
	   <info>									\
	     <property name=\"program\">smooth</property>				\
	     <property name=\"language\">Greek / Ελληνικά</property>			\
	     <property name=\"righttoleft\">false</property>				\
	     <property name=\"encoding\">UTF-8</property>				\
	   </info>									\
	   <data>									\
	     <entry string=\"OK\">Εντάξει</entry>					\
	     <entry string=\"Cancel\">Ακύρωση</entry>					\
	     <entry string=\"Yes\">Ναι</entry>						\
	     <entry string=\"No\">Όχι</entry>						\
	     ...
	     <entry string=\"Next tip\">Επόμενο</entry>					\
	   </data>									\
	 </LangFile>";

...
#ifndef H_OBJSMOOTH_I18N_JA
#define H_OBJSMOOTH_I18N_JA

static const char *smooth_ja = 

	"<?xml version=\"1.0\" encoding=\"UTF-8\"?>				\
	 <LangFile>								\
	   <info>								\
	     <property name=\"program\">smooth</property>			\
	     <property name=\"language\">Japanese / 日本語</property>		\
	     <property name=\"righttoleft\">false</property>			\
	     <property name=\"encoding\">UTF-8</property>			\
	   </info>								\
	   <data>								\
	     <entry string=\"OK\">OK</entry>					\
	     <entry string=\"Cancel\">キャンセル</entry>				\
	     <entry string=\"Yes\">はい</entry>					\
	     <entry string=\"No\">いいえ</entry>					\
	     ...
	     <entry string=\"Next tip\">次の秘訣</entry>				\
	   </data>								\
	 </LangFile>";

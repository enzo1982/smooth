...
S::Int S::I18n::TranslatorInternal::GetSupportedLanguages()
{
	...
	for (Int i = 0; i < 43; i++)
	{
		...
		else if	(i ==  9) xml = smooth_eu;
		else if	(i == 10) xml = smooth_fa;
		else if	(i == 11) xml = smooth_fi;
		else if	(i == 12) xml = smooth_fr;
		else if	(i == 13) xml = smooth_gl;
		else if	(i == 14) xml = smooth_he;
		else if	(i == 15) xml = smooth_hi;
		else if	(i == 16) xml = smooth_hr;
		else if	(i == 17) xml = smooth_hu;
		else if	(i == 18) xml = smooth_id;
		else if (i == 19) xml = smooth_it;
		else if (i == 20) xml = smooth_ja;
		else if	(i == 21) xml = smooth_ko;
		else if	(i == 22) xml = smooth_lt;
		else if	(i == 23) xml = smooth_lv;
		else if	(i == 24) xml = smooth_ms;
		else if	(i == 25) xml = smooth_nl;
		else if	(i == 26) xml = smooth_no;
		else if	(i == 27) xml = smooth_pa;
		else if	(i == 28) xml = smooth_pl;
		else if	(i == 29) xml = smooth_pt;
		else if	(i == 30) xml = smooth_pt_BR;
		else if	(i == 31) xml = smooth_ro;
		else if (i == 32) xml = smooth_ru;
		else if	(i == 33) xml = smooth_sk;
		else if	(i == 34) xml = smooth_sl;
		else if (i == 35) xml = smooth_sr;
		else if	(i == 36) xml = smooth_sv;
		else if	(i == 37) xml = smooth_th;
		else if	(i == 38) xml = smooth_tr;
		else if	(i == 39) xml = smooth_uk;
		else if (i == 40) xml = smooth_vi;
		else if (i == 41) xml = smooth_zh_CN;

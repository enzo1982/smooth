...
S::Int S::IO::FilterBZip2::WriteData(Buffer<UnsignedByte> &data)
{
	...
	BZ2_bzBuffToBuffCompress((char *) dest, (unsigned int *) &outsize, (char *) (UnsignedByte *) data, data.Size(), 5, 0, 0);

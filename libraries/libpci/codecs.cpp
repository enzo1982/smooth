...
#ifndef __LIBPCI_COMPRESS_
#define __LIBPCI_COMPRESS_
...
int GetRLE(int line[], int sx, int x, int maxbits)
{
	...
	for (int i = x + 1; i < x + pow(2, maxbits); i++)
	{
...
int GetDelta(int line[], int prevline[], int x, int parts)
{
	...
	switch (parts)
	{
		...
		case 3:
			...
			if (((redbias > -pow(2, 5)) && (redbias <= pow(2, 5))) && ((greenbias > -pow(2, 5)) && (greenbias <= pow(2, 5))) && ((bluebias > -pow(2, 5)) && (bluebias <= pow(2, 5))))
			{
				return 1;
			}
		...
		case 4:
			...
			if (((redbias > -pow(2, 5)) && (redbias <= pow(2, 5))) && ((greenbias > -pow(2, 5)) && (greenbias <= pow(2, 5))) && ((bluebias > -pow(2, 5)) && (bluebias <= pow(2, 5))) && ((alphabias > -pow(2, 5)) && (alphabias <= pow(2, 5))))
			{
				return 1;
			}
...
int CompressDelta(int line[], int prevline[], int x, int parts, PCIOut out)
{
	...
	switch (parts)
	{
		...
		case 3:
			...
			if (((redbias > -pow(2, 2)) && (redbias <= pow(2, 2))) && ((greenbias > -pow(2, 2)) && (greenbias <= pow(2, 2))) && ((bluebias > -pow(2, 2)) && (bluebias <= pow(2, 2))))
			{
				out->OutputNumberPBD(0, 2);
				md = 2;
			}
			else if (((redbias > -pow(2, 3)) && (redbias <= pow(2, 3))) && ((greenbias > -pow(2, 3)) && (greenbias <= pow(2, 3))) && ((bluebias > -pow(2, 3)) && (bluebias <= pow(2, 3))))
			{
				out->OutputNumberPBD(1, 2);
				md = 3;
			}
			else if (((redbias > -pow(2, 4)) && (redbias <= pow(2, 4))) && ((greenbias > -pow(2, 4)) && (greenbias <= pow(2, 4))) && ((bluebias > -pow(2, 4)) && (bluebias <= pow(2, 4))))
			{
				out->OutputNumberPBD(2, 2);
				md = 4;
			}
			else if (((redbias > -pow(2, 5)) && (redbias <= pow(2, 5))) && ((greenbias > -pow(2, 5)) && (greenbias <= pow(2, 5))) && ((bluebias > -pow(2, 5)) && (bluebias <= pow(2, 5))))
			{
		...
		case 4:
			...
			if (((redbias > -pow(2, 2)) && (redbias <= pow(2, 2))) && ((greenbias > -pow(2, 2)) && (greenbias <= pow(2, 2))) && ((bluebias > -pow(2, 2)) && (bluebias <= pow(2, 2))) && ((alphabias > -pow(2, 2)) && (alphabias <= pow(2, 2))))
			{
				out->OutputNumberPBD(0, 2);
				md = 2;
			}
			else if (((redbias > -pow(2, 3)) && (redbias <= pow(2, 3))) && ((greenbias > -pow(2, 3)) && (greenbias <= pow(2, 3))) && ((bluebias > -pow(2, 3)) && (bluebias <= pow(2, 3))) && ((alphabias > -pow(2, 3)) && (alphabias <= pow(2, 3))))
			{
				out->OutputNumberPBD(1, 2);
				md = 3;
			}
			else if (((redbias > -pow(2, 4)) && (redbias <= pow(2, 4))) && ((greenbias > -pow(2, 4)) && (greenbias <= pow(2, 4))) && ((bluebias > -pow(2, 4)) && (bluebias <= pow(2, 4))) && ((alphabias > -pow(2, 4)) && (alphabias <= pow(2, 4))))
			{
				out->OutputNumberPBD(2, 2);
				md = 4;
			}
			else if (((redbias > -pow(2, 5)) && (redbias <= pow(2, 5))) && ((greenbias > -pow(2, 5)) && (greenbias <= pow(2, 5))) && ((bluebias > -pow(2, 5)) && (bluebias <= pow(2, 5))) && ((alphabias > -pow(2, 5)) && (alphabias <= pow(2, 5))))
			{
				out->OutputNumberPBD(3, 2);
				md = 5;
			}
